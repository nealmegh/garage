...
@section('content')
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        ...
        <div class="" style="alignment: right">
            <a href="{{route('purchase.create')}}" class="btn btn-dark mb-2"><i class="fas fa-plus"></i> add Purchase</a>
        </div>
...
{{--                        <th>Actions</th>--}}
                    ...
                    <tr class="tr-shadow">
                        <td>{{$purchase->id}}</td>
                        <td>
                            <span class="block-email">{{$purchase->supplier_name}}</span>
                        </td>
                        <td class="desc">{{$purchase->grand_total}}</td>
                        <td>{{$purchase->closing_due}}</td>
                        <td>
                            <span class="status--process">{{$purchase->closing_balance}}</span>
                        </td>


{{--                        <td>--}}
{{--                            <a href="/purchase/edit/{{$purchase->id}}" data-toggle="tooltip" title="Edit"> <i class="fa fa-edit" aria-hidden="true"></i> </a>--}}
