...
@section('content')
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        ...
        <div class="" style="alignment: right">
            <a href="{{route('customer.create')}}" class="btn btn-dark mb-2"><i class="fas fa-plus"></i> add Customer</a>
        </div>
                    ...
                    @foreach($customers as $customer)
                        <tr class="tr-shadow">
                            ...
                            <td>
                                ...
                                {{$customer->customer_contact1}} <br>
                                {{$customer->customer_contact2}}
                            </td>
                            <td>{{$customer->balance}}</td>
                            <td>{{$customer->due}}</td>
                            <td><a href="{{route('customer.edit', $customer->id)}}" data-toggle="tooltip" title="Edit"> <i class="fa fa-edit" aria-hidden="true"></i> </a>
{{--                                <a href="/category/destroy/{{$customer->id}}" data-toggle="tooltip" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>--}}
                            </td>
                        </tr>
