...
@section('content')
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        ...
        <div class="" style="alignment: right">
            <a href="{{route('category.create')}}" class="btn btn-dark mb-2"><i class="fas fa-plus"></i> add Category</a>
        </div>
                ...
                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                    ...
                    @foreach($categories as $category)
                        <tr class="tr-shadow">
                            ...
                            <td><a href="{{route('category.edit',$category->id) }}" data-toggle="tooltip" title="Edit"> <i class="far fa-edit"></i> </a>
{{--                                <a href="/category/destroy/{{$category->id}}" data-toggle="tooltip" title="Delete"><i class="fa fa-trash"></i></a>--}}
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
