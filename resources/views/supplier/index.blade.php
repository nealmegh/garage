...
@section('content')
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        ...
        <div class="" style="alignment: right">
            <a href="{{route('supplier.create')}}" class="btn btn-dark mb-2"><i class="fas fa-plus"></i> add Supplier</a>
        </div>
            ...
            <div class="table-responsive mb-4 mt-4">
                ...
                <table id="html5-extension" class="table table-hover non-hover" style="width:100%">
                    ...
                    <tr class="tr-shadow">
                        <td>{{$supplier->id}}</td>
                        <td>
                            <span class="block-email">{{$supplier->supplier_name}}</span>
                        </td>
                        <td class="desc">{{$supplier->supplier_email}}</td>
                        <td>{{$supplier->supplier_address}}</td>
                        <td>
                            <span class="status--process">{{$supplier->supplier_contact1}}</span>
                        </td>
                        <td>{{$supplier->balance}}</td>
                        <td>{{$supplier->due}}</td>

                        <td><a href="{{route('supplier.edit', $supplier->id)}}" data-toggle="tooltip" title="Edit"> <i class="fa fa-edit" aria-hidden="true"></i> </a>
{{--                            <a href="/supplier/destroy/{{$supplier->id}}" data-toggle="tooltip" title="Delete"><i class="fa fa-trash" aria-hidden="true"></i></a>--}}
