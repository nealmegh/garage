...
@section('content')
    ...
    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
        ...
        <div class="" style="alignment: right">
            <a href="{{route('owner.create')}}" class="btn btn-dark mb-2"><i class="fas fa-plus"></i> add Owner</a>
        </div>

        <div class="widget-content widget-content-area br-6">
            <div class="table-responsive mb-4 mt-4">
                <h3 class="title-5 m-b-35">Owners Table</h3>
...
{{--                                    <a type="button" href="#" class="btn btn-dark btn-sm">View</a>--}}
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuReference1">
                                        <a class="dropdown-item" href="{{route('owner.edit', $owner->id)}}">Edit</a>
                                    </div>
                                </div>
                            </td>
                        </tr>
