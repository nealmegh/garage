...
@section('content')
    <div class="col-xl-12 col-lg-12 col-md-12 col-12 layout-spacing">
        <div class="statbox widget box box-shadow">
            ...
            <form class="form-horizontal create_stock" role="form" method="POST" action="{{route('stock.update', $stockDetail->id) }}">
                @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control search_category_name" placeholder="Type here ..." name="category_name" autocomplete="off" value="{{$stockDetail->category_name}}" disabled>
                                <span class="help-block search_category_name_empty" style="display: none;">No Results Found ...</span>
                                <input type="hidden" class="search_category_id" name="category_id" value="{{$stockDetail->category_id}}">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Type here ..." name="stock_name" value="{{$stockDetail->stock_name}}">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="purchase_cost" placeholder="0.00" value="{{$stockDetail->purchase_cost}}">
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="selling_cost" placeholder="0.00" value="{{$stockDetail->selling_cost}}">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" placeholder="Type here ..." name="stock_quantity" value="{{$stockDetail->stock_quantity}}">
                            </div>
                        </div>
...
{{--                                {{dd($stockDetail->stock_unit)}}--}}
                                <select class="form-control change_supplier_name selectpicker" name="unit_type" id="unit_type">
                                    <option selected="" disabled="" value=""> Select </option>
                                    @if($stockDetail->stock_unit->unit_type == 'kg')
                                        <option value="kg" selected="selected">Kilograms</option>
                                    @else
                                        <option value="kg">Kilograms</option>
                                    @endif
                                    @if($stockDetail->stock_unit->unit_type == 'lt')
                                        <option value="lt" selected="selected">Liters</option>
                                    @else
                                        <option value="lt">Liters</option>
                                    @endif
                                    @if($stockDetail->stock_unit->unit_type == 'pcs')
                                        <option value="pcs" selected="selected">Pieces</option>
                                    @else
                                        <option value="pcs">Pieces</option>
                                    @endif
                                    @if($stockDetail->stock_unit->unit_type == 'grm')
                                        <option value="grm" selected="selected">Grams</option>
                                    @else
                                        <option value="grm">Grams</option>>
                                    @endif
                                    @if($stockDetail->stock_unit->unit_type == 'set')
                                        <option value="set" selected="selected">Sets</option>
                                    @else
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control change_supplier_name selectpicker" name="supplier_id" id="supplier_id" data-live-search="true">
                                    ...
                                    @foreach($suppliers as $key => $value)
                                        @if($stockDetail->supplier_id == $value->id)
                                ...
                                <input type="hidden" name="supplier_name" class="supplier_name" value="{{$value->supplier_name}}">
                            </div>
                        </div>
