<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        <div class="profile-info">
            ...
            <div class="user-info">
                <img src="{{asset('/images/icon/avatar-01.jpg')}}" alt="avatar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            <li class="menu {{ (request()->is('dashboard*')) ? 'active' : '' }}">
                <a href="#dashboard" data-toggle="collapse" aria-expanded="{{ (request()->is('dashboard*')) ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
            ...
            <li class="menu {{ (request()->is('rent*')) ? 'active' : '' }}">
                <a href="#rents" data-toggle="collapse" aria-expanded="{{ (request()->is('rent*')) ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
{{--                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-home"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path><polyline points="9 22 9 12 15 12 15 22"></polyline></svg>--}}
                ...
                <ul class="collapse submenu recent-submenu mini-recent-submenu list-unstyled show" id="rents" data-parent="#accordionExample">
                    <li class="{{ (request()->is('rents')) ? 'active' : '' }}">
                        <a href="{{route('rent.index')}}"> Rents </a>
                    </li>
                    <li class="{{ (request()->is('rents/archived')) ? 'active' : '' }}">
                        <a href="{{route('rent.archived')}}"> Past Rents </a>
                    </li>
                </ul>
            </li>
{{--            <li class="menu {{ (request()->is('rent*')) ? 'active' : '' }}">--}}
{{--                <a href="{{route('rent.index')}}"  aria-expanded="{{ (request()->is('rent*')) ? 'true' : 'false' }}" class="dropdown-toggle">--}}
{{--                    <div class="">--}}
{{--                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-calendar"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect><line x1="16" y1="2" x2="16" y2="6"></line><line x1="8" y1="2" x2="8" y2="6"></line><line x1="3" y1="10" x2="21" y2="10"></line></svg>--}}
...
{{--            </li>--}}
            ...
            <li class="menu {{ (request()->is('vehicle*')) ? 'active' : '' }}">
                <a href="{{route('vehicle.index')}}"  aria-expanded="{{ (request()->is('vehicle*')) ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
...
{{--                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-zap"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>--}}
            ...
            <li class="menu {{ (request()->is('case*')) ? 'active' : '' }}">
                <a href="{{route('case.index')}}"  aria-expanded="{{ (request()->is('case*')) ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
...
{{--                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-zap"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>--}}
            ...
            <li class="menu {{ (request()->is('damage*')) ? 'active' : '' }}">
                <a href="{{route('damage.index')}}" aria-expanded="{{ (request()->is('damage*')) ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
...
{{--                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-zap"><polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"></polygon></svg>--}}
            ...
            <li class="menu {{ (request()->is('user*')) ? 'active' : '' }}">
                <a href="#users" data-toggle="collapse" aria-expanded="{{ (request()->is('user*')) ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
...
{{--                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-box"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>--}}
            ...
            <li class="menu {{ (request()->is('driver*')) ? 'active' : '' }}">
                <a href="{{route('driver.index')}}" aria-expanded="{{ (request()->is('driver*')) ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
...
{{--                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-box"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>--}}
            ...
            <li class="menu {{ (request()->is('owner*')) ? 'active' : '' }}">
                <a href="{{route('owner.index')}}" aria-expanded="{{ (request()->is('owner*')) ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
...
{{--                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-box"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>--}}
            ...
            <li class="menu {{ (request()->is('transactions*')) ? 'active' : '' }}">
                <a href="{{route('transaction.index')}}" aria-expanded="{{ (request()->is('transactions')) ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
...
{{--                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-users"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path><circle cx="9" cy="7" r="4"></circle><path d="M23 21v-2a4 4 0 0 0-3-3.87"></path><path d="M16 3.13a4 4 0 0 1 0 7.75"></path></svg>--}}
            ...
            <li class="menu {{ (request()->is('inventory*')) ? 'active' : '' }}">
                <a href="#inventory" data-toggle="collapse" aria-expanded="{{ (request()->is('inventory*')) ? 'true' : 'false' }}" class="dropdown-toggle">
                    <div class="">
...
{{--                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-lock"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg>--}}
                ...
                <ul class="collapse submenu list-unstyled" id="inventory" data-parent="#accordionExample">
                    ...
                    <li class=" @if(Request::is('purchase*')) active @endif">
