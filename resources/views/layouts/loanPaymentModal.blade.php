...
<div class="modal fade" id="loanPayment" tabindex="-1"  role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <form action="{{route('transaction.store')}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-12 col-md-9">
                            <select name="driver_id" id="loan_driver_id" class="form-control" required>
                    ...
                    <input type="hidden" name="payment_for" value="loanPayment">
